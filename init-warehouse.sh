...
echo "PostgreSQL is ready! Initializing warehouse schema..."

# Create warehouse schema
psql -U data_engineer -d ecommerce_warehouse << EOF
-- ===================================================================
...
CREATE INDEX IF NOT EXISTS idx_fact_events_session ON fact_events(session_key);
CREATE INDEX IF NOT EXISTS idx_agg_product_perf_date ON agg_product_performance(metric_date);
